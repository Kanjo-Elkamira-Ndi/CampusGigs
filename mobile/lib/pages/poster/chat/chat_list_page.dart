...
class PosterChatListPage extends ConsumerWidget {
  const PosterChatListPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final conversationsAsync = ref.watch(posterChatProvider);
        ...
        data: (conversations) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) => ChatTile(
              ...
              onTap: () {
                ref.read(posterChatProvider.notifier).markAsRead(
                      conversations[index].id,
                    );
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => PosterConversationPage(
                      conversation: conversations[index],
                    ),
                  ),
                );
