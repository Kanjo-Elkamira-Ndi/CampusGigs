...
export const CATEGORY_META = {
  Tutoring: { bg: "bg-green-50 dark:bg-green-950", text: "text-green-700 dark:text-green-400" },
  Errands: { bg: "bg-amber-50 dark:bg-amber-950", text: "text-amber-700 dark:text-amber-400" },
  "Tech help": { bg: "bg-blue-50 dark:bg-blue-950", text: "text-blue-700 dark:text-blue-400" },
  Events: { bg: "bg-purple-50 dark:bg-purple-950", text: "text-purple-700 dark:text-purple-400" },
  Creative: { bg: "bg-pink-50 dark:bg-pink-950", text: "text-pink-700 dark:text-pink-400" },
  Delivery: { bg: "bg-orange-50 dark:bg-orange-950", text: "text-orange-700 dark:text-orange-400" },
  Translation: { bg: "bg-teal-50 dark:bg-teal-950", text: "text-teal-700 dark:text-teal-400" },
